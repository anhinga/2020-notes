...
\vspace{0.085in}
August 7, 2020\footnote{Version 1.9. Version 1 (12-27-19) is at
...
of the quest to understand why this architecture and especially its GPT-3 incarnation work so well\footnote{As of early August 2020}.
...
\begin{itemize}
   \item Can what we know about DMMs shed some light on the remarkable properties of Transformers?
   \item Can we incorporate key elements from Transformer architecture into a more flexible DMM setup, and by
           doing so obtain interesting compact and low training cost models?
\end{itemize}
