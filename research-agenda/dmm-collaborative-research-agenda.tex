...
\vspace{0.085in}
August 6, 2020\footnote{Version 1.8. Version 1 (12-27-19) is at
...
The initial training of Transformers tend to be quite costly, but their adaptation (``fine-tuning") to new tasks
...
These impressive capabilities were taken to the entirely new level with the introduction of GPT-3 and OpenAI API in
May-June of this year.\footnote{See my note at \href{https://www.cs.brandeis.edu/~bukatin/transformer\_revolution.html}{\tt https://www.cs.brandeis.edu/$\sim$bukatin/transformer\_revolution.html}} I think the community is only at the beginning
of the quest to understand why this architecture and especially its GPT-3 incarnation work so well.
